...
class QRScannerPage extends StatefulWidget {
  ...
  @override
  _QRScannerPageState createState() => _QRScannerPageState(validateappointmentId: validateappointmentId);
}
...
class _QRScannerPageState extends State<QRScannerPage> {
  ...
  Future<bool> _validateQRData(Map<String, dynamic> data) async {
    try {
      ...
      if (widget.validateappointmentId == appointmentId) {
        String apiUrl = 'http://192.168.91.156:8080/pkums/appointment/validateappointment/$appointmentId/$date/$time/$status/patient/$patientId';
  ...
  Future<void> _updateAppointment(Map<String, dynamic> data) async {
    ...
    // Prepare the API endpoint and request
    String apiUrl = 'http://192.168.91.156:8080/pkums/appointment/updateappointment/$appointmentId';
