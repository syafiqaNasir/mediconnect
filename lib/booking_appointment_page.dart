...
class _BookingPageState extends State<BookingPage> {
  ...
  Future<void> validateAppointment(String date, String time, String status,
    ...
    final response = await http.get(Uri.parse('http://10.131.75.14:8080/pkums/appointment/getappointment/$date/$time'));
  ...
  Future<void> insertAppointment(String? bookingDate, String? bookingTime,
    ...
    final Uri uri = Uri.parse('http://10.131.75.14:8080/pkums/appointment/insertappointment');
